...
<html><head><meta charset="utf-8"><title>CropSight Field Report — ${field.name}</title>
<style>
...
<footer>Generated by CropSight · ${new Date().toISOString()}</footer>
</body></html>`;
  ...
  a.href = url;
  a.download = `cropsight-report-${field.name.toLowerCase().replace(/\s+/g, '-')}.html`;
  a.click();
