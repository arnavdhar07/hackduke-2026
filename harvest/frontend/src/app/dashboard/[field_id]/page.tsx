...
<html><head><meta charset="utf-8"><title>Harvest Field Report — ${field.name}</title>
<style>
...
<footer>Generated by Harvest · ${new Date().toISOString()}</footer>
</body></html>`;
  ...
  a.href = url;
  a.download = `harvest-report-${field.name.toLowerCase().replace(/\s+/g, '-')}.html`;
  a.click();
